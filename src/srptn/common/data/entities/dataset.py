...
class Dataset(Entity):
    ...
    data_files: list[UploadedFile] | None = None
    meta_files: list[UploadedFile] | None = None
    ...
    def show(self) -> None:
        ...
        if not meta_files.is_empty() and self._data_store:
    ...
    def store(self, data_store: DataStore) -> None:
        ...
        if isinstance(self.sheet, pl.DataFrame):
