...
def test_update_schema():
  with open("testdata/config.yaml", "r") as f:
    config = load_yaml(f)
  with open("testdata/config.schema.yaml", "r") as f:
    schema = load_yaml(f)
  updated_schema = schemas.update_schema(schema, config)
  with open("testdata/config.schema.updated.yaml", "r") as f:
...
def test_infer_schema():
  ...
  with open("testdata/config.schema.infered.yaml", "r") as f:
